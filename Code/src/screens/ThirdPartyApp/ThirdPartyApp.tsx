...
import { thirdPartyAppsStyles } from "./ThirdPartyAppStyles";

const ThirdPartyApp = (props: any) => {
  ...
  return (
    ...
    >
      ...
      <Header title="Third Party Apps" type="Back" />
      <FlatList
        contentContainerStyle={thirdPartyAppsStyles.flatListContainer}
        data={appData}
        renderItem={({ item }) => (
          <>
            {item.is_third_party && (
              ...
              >
                ...
                >
                  ...
                  >
                    <Image
                      source={appImage[item.source]}
                      style={thirdPartyAppsStyles.icons}
                    />
                  </View>
                  <View
                    style={[
